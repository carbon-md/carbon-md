...
| **L3** Certifié | une entrée au registre de certification carbon.md — *pas encore livré* ; un document qui le revendique est rapporté au niveau que ses preuves soutiennent |
...
La clé publique est incluse dans le `did:key` du sujet : les étapes 1 à 3 fonctionnent donc **sans aucun réseau**.
