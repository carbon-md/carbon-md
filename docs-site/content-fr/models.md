...
**Dernier steer :** 2026-08-23 · `carbonmd-factors-2026-08`
...
## Small
`gpt-5.6-luna`, `gpt-5.4-mini`, `gemini-3.5-flash`, `gemini-3.6-flash`, `gemini-3.7-flash`, `deepseek-v4-flash`, `deepseek-v4-flash-vision-exp`, `grok-composer-2.5-fast`, `step-3.7-flash`, `nemotron-3.5-lightning`, `lfm-2.5-2.6b`, `hy-mt2-1.8b`, `hy-mt2-7b`, `hy-mt2-30b-a3b`
...
## Medium
Inconnu / guessed. Vu cette semaine sans règle famille : `stealth/ox-alpha`.
