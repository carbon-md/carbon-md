...
The pinned factor-table version, e.g. `carbonmd-factors-2026-07`. Estimates are only comparable within a methodology version. See [Methodology & factors](/methodology/).
...
{ "type":"usage", "ts":"2026-08-01T09:12:00Z", "source":"claude-code",
  ...
  "model_class":"large", "factors":"carbonmd-factors-2026-07",
